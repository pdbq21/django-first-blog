...
This issue page has been created to monitor information on African bushmeat over the issue period to assist with understanding of this trade.`
        ...
        Group: {
            Name: [
                'Ongoing', 'Emerging', 'Past', 'Potential', 'Africa', 'Chile', 'risks', 'Foot', 'population', 'Panama', 'August',
            ]
        },
        Issue: {
            Name: [
                'Citrus greening', 'Huanglongbing in Central', 'integrated technologies', 'Whirling disease', 'the first time in Canada',
                'Issues combined', 'the disease risks', 'the fish kill', 'Mayors Landing Fishing Access', 'Whirling disease',
        ...
        return (
            <div>
                <form action="">
                    ...
                    <button type="button" className="search" onClick={this.handelClickButtonSearch.bind(this)}>Search
                    </button>

                </form>
                {/* 1. view search result */}
                <SearchResultView data={this.state.data}/>
                {/* end 1. */}
            </div>
        );
    }
